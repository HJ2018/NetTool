...
#define kXMLParserTextNodeKey        (@"NET_TXT")
...
+ (NSDictionary *)dictionaryForXMLData:(NSData *)data options:(XMLParserOptions)options{
    XMLParser  * whc_xmlParser = [XMLParser new];
...
- (NSDictionary*)startParserXML:(NSData*)data options:(XMLParserOptions)options{
...
- (void)parser:(NSXMLParser *)parser parseErrorOccurred:(NSError *)parseError{
    if(parseError){
        NSLog(@"XMLParserError :%@",parseError);
    }
}
